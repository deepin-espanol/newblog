...
image_path: /images/actividades/traduccion.jpg
external_url:
---
...
<img src="{{ site.baseurl }}/images/posts/deepintransifex.png" alt="La página de traducción en Transifex.">
<img src="{{ site.baseurl }}/images/posts/Transifexchinesse" alt="Seleccionando el idioma origen chino.">

## Recomendaciones

* Tenemos un [listado en crecimiento]({{ site.data.externalurl.ayudadeepin }}/deepin/traducciones/). La mayoría en español internacional.
...
* Tienes la [información de contacto]({{ site.url }}{{ site.baseurl }}/redes/) para comunicar con los colaboradores.
